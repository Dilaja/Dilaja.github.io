  ...
  return (
    <section id="contact" className="py-20 bg-[#121212] px-4">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-[#E0E0E0] mb-3">Get In Touch</h2>
        <p className="text-slate-400 mb-12">Let's discuss opportunities, collaborations, or engineering solutions.</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-[#1e1e1e] p-8 rounded-2xl border border-[#2c2c2c] shadow-xl flex flex-col justify-between">
            <div>
              <h3 className="text-xl font-semibold text-[#E0E0E0] mb-6">Contact Information</h3>
              ...
              <ul className="space-y-6 mb-8">
                <li className="flex items-start gap-4">
                 ...
                 <li className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="block text-sm text-slate-400">Contact Number</span>
            ...
            <div>
              <h4 className="text-sm font-semibold uppercase tracking-wider text-slate-400 mb-4">Connect on Socials</h4>
          ...
          <div className="bg-[#1e1e1e] p-8 rounded-2xl border border-[#2c2c2c] shadow-xl relative">
            {submitted ? (
              <div className="absolute inset-0 bg-[#1e1e1e] rounded-2xl flex flex-col items-center justify-center p-6 text-center animate-fadeIn">
                ...
                <h3 className="text-2xl font-bold text-[#E0E0E0] mb-2">Message Sent!</h3>
                <p className="text-slate-400">Thank you for reaching out. I will get back to you shortly.</p>
              </div>
            ) : null}
