    ...
    <section id="about" className="py-20 bg-[#121212] px-4">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-[#E0E0E0] mb-10 border-b border-[#2c2c2c] pb-3">
          {t?.profSummary || "Professional Summary"}
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="md:col-span-2 bg-[#1e1e1e] rounded-2xl p-6 sm:p-8 shadow-xl border border-[#2c2c2c]">
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-4">
              {t?.aboutText1 || "Results-driven Full-Stack Developer and Software Engineer with extensive experience in modernizing mission-critical national infrastructure, building high-uptime web platforms, and providing robust software support."}
            </p>
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-6">
              {t?.aboutText2 || "Combines MERN mastery—React, Node.js, TypeScript, and rigorous TDD—with a Master's degree (Full Stack Software Development) from Finland (JAMK University of Applied Sciences)."}
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-[#2c2c2c]">
              <div className="bg-[#121212] p-4 rounded-xl border border-[#2c2c2c]">
                ...
                <span className="text-slate-400 text-sm">
                  {t?.stat1 || "Reduction in production bugs via robust TDD protocols"}
                </span>
              </div>
              <div className="bg-[#121212] p-4 rounded-xl border border-[#2c2c2c]">
                <span className="block text-[#00E5FF] font-bold text-2xl mb-1">70%</span>
                <span className="text-slate-400 text-sm">
                  {t?.stat2 || "Acceleration in deployment cycles using Azure CI/CD"}
                </span>
              </div>
            </div>
          </div>
